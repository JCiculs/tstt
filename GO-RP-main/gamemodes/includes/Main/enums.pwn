...
enum char_pizza_data
{
	Player_Vehicle_ID,
}
enum char_trucker_data {
	Player_Vehicle_ID,
}
//Khu an toan
enum szInfo
...
enum{
	...
	DIALOG_GROUP_CAUTHANG,
	DIALOG_GROUP_BANGGON,
	DIALOG_GROUP_CRATE,
...
//Vut sung
//___________Dropgun___________
new DropObject[MAX_DROP_ITEMS];

//__________Dropgun__________
enum dData
{
    DropGunModel,
    Float:DropGunPosX,
...
//eshop
enum Service{ // CAI NAY PHAI DI TRUOC
	esID,
	Float:esPos[3],
	esName[MAX_PLAYER_NAME],
	esService[128],
	esIdint,
	esPrice,
	esZone[128],
...
new Eshop[ORDER][Service]; // SAU DO NO MOI NHAN DUOC CAI O DUOI
new hsprice = 500,//nha
	dsprice = 700,//door
	gsprice = 500,//gate
	grsprice = 400,//garage
	smallintsprice = 400,//int small
	bigintsprice = 500;//int big
