...
Group_DisbandGroup(iGroupID) {
	...
	arrGroupData[iGroupID][g_iCauThangls] = INVALID_RANK;
	arrGroupData[iGroupID][g_iBangGonls] = INVALID_RANK;
...
public OnQueryFinish(resultid, extraid, handleid)
{
	...
	switch(resultid)
	{
		...
		case LOADUSERDATA_THREAD:
		{
			if(IsPlayerConnected(extraid))
			{
				...
				for(new row;row < rows;row++)
				{
					...
					cache_get_field_content(row,  "Skin1", szResult, MainPipeline); PlayerInfo[extraid][pSkin1] = strval(szResult);
					cache_get_field_content(row,  "Skin2", szResult, MainPipeline); PlayerInfo[extraid][pSkin2] = strval(szResult);
					cache_get_field_content(row,  "Skin3", szResult, MainPipeline); PlayerInfo[extraid][pSkin3] = strval(szResult);
					cache_get_field_content(row,  "Skin4", szResult, MainPipeline); PlayerInfo[extraid][pSkin4] = strval(szResult);
					cache_get_field_content(row,  "Skin5", szResult, MainPipeline); PlayerInfo[extraid][pSkin5] = strval(szResult);
					cache_get_field_content(row,  "Skin6", szResult, MainPipeline); PlayerInfo[extraid][pSkin6] = strval(szResult);
					cache_get_field_content(row,  "Skin7", szResult, MainPipeline); PlayerInfo[extraid][pSkin7] = strval(szResult);
					cache_get_field_content(row,  "Skin8", szResult, MainPipeline); PlayerInfo[extraid][pSkin8] = strval(szResult);
					cache_get_field_content(row,  "Skin9", szResult, MainPipeline); PlayerInfo[extraid][pSkin9] = strval(szResult);
					cache_get_field_content(row,  "Skin10", szResult, MainPipeline); PlayerInfo[extraid][pSkin10] = strval(szResult);
					cache_get_field_content(row,  "Skin11", szResult, MainPipeline); PlayerInfo[extraid][pSkin11] = strval(szResult);
					cache_get_field_content(row,  "Skin12", szResult, MainPipeline); PlayerInfo[extraid][pSkin12] = strval(szResult);
					cache_get_field_content(row,  "Skin13", szResult, MainPipeline); PlayerInfo[extraid][pSkin13] = strval(szResult);
					cache_get_field_content(row,  "Skin14", szResult, MainPipeline); PlayerInfo[extraid][pSkin14] = strval(szResult);
					cache_get_field_content(row,  "Skin15", szResult, MainPipeline); PlayerInfo[extraid][pSkin15] = strval(szResult);
					cache_get_field_content(row,  "Skin16", szResult, MainPipeline); PlayerInfo[extraid][pSkin16] = strval(szResult);
					cache_get_field_content(row,  "Skin17", szResult, MainPipeline); PlayerInfo[extraid][pSkin17] = strval(szResult);
					cache_get_field_content(row,  "Skin18", szResult, MainPipeline); PlayerInfo[extraid][pSkin18] = strval(szResult);
					cache_get_field_content(row,  "Skin19", szResult, MainPipeline); PlayerInfo[extraid][pSkin19] = strval(szResult);
					cache_get_field_content(row,  "Skin20", szResult, MainPipeline); PlayerInfo[extraid][pSkin20] = strval(szResult);
					cache_get_field_content(row,  "TienBan", szResult, MainPipeline); PlayerInfo[extraid][pTienBan] = strval(szResult);
					cache_get_field_content(row,  "DauSach", szResult, MainPipeline); PlayerInfo[extraid][pDauSach] = strval(szResult);
					cache_get_field_content(row,  "Dau", szResult, MainPipeline); PlayerInfo[extraid][pDau] = strval(szResult);
					cache_get_field_content(row,  "Gpvk", szResult, MainPipeline); PlayerInfo[extraid][pGpvk] = strval(szResult);
					cache_get_field_content(row,  "MoneyPhone", szResult, MainPipeline); PlayerInfo[extraid][pMoneyPhone] = strval(szResult);
					cache_get_field_content(row,  "FixJob", szResult, MainPipeline); PlayerInfo[extraid][pFixJob] = strval(szResult);
					cache_get_field_content(row,  "Gpxl", szResult, MainPipeline); PlayerInfo[extraid][pGpxl] = strval(szResult);
					cache_get_field_content(row,  "Go", szResult, MainPipeline); PlayerInfo[extraid][pGo] = strval(szResult);
					cache_get_field_content(row,  "BaiDauXe", szResult, MainPipeline); PlayerInfo[extraid][pBaiDauXe] = strval(szResult);
					cache_get_field_content(row,  "ThuocSung", szResult, MainPipeline); PlayerInfo[extraid][pThuocSung] = strval(szResult);
					cache_get_field_content(row,  "DongCo", szResult, MainPipeline); PlayerInfo[extraid][pDongCo] = strval(szResult);
					cache_get_field_content(row,  "BanhXe", szResult, MainPipeline); PlayerInfo[extraid][pBanhXe] = strval(szResult);
					cache_get_field_content(row,  "Phieunuoibo", szResult, MainPipeline); PlayerInfo[extraid][pPhieunuoibo] = strval(szResult);
					cache_get_field_content(row,  "Xabeng", szResult, MainPipeline); PlayerInfo[extraid][pXabeng] = strval(szResult);
					cache_get_field_content(row,  "MuiXe", szResult, MainPipeline); PlayerInfo[extraid][pMuiXe] = strval(szResult);
					cache_get_field_content(row,  "CoLe", szResult, MainPipeline); PlayerInfo[extraid][pCoLe] = strval(szResult);
					cache_get_field_content(row,  "Mph", szResult, MainPipeline); PlayerInfo[extraid][pMph] = strval(szResult);
					cache_get_field_content(row,  "Gang", szResult, MainPipeline); PlayerInfo[extraid][pGang] = strval(szResult);
					cache_get_field_content(row,  "Giap", szResult, MainPipeline); PlayerInfo[extraid][pGiap] = strval(szResult);
					cache_get_field_content(row,  "HackWeapons", szResult, MainPipeline); PlayerInfo[extraid][pWeapons] = strval(szResult);
					cache_get_field_content(row,  "UidMask", szResult, MainPipeline); PlayerInfo[extraid][pUidMask] = strval(szResult);
					cache_get_field_content(row,  "HatGiong", szResult, MainPipeline); PlayerInfo[extraid][pHatGiong] = strval(szResult);
					cache_get_field_content(row,  "CanSa", szResult, MainPipeline); PlayerInfo[extraid][pCansa] = strval(szResult);
					cache_get_field_content(row,  "CanSap", szResult, MainPipeline); PlayerInfo[extraid][pCansap] = strval(szResult);
					cache_get_field_content(row,  "Banh", szResult, MainPipeline); PlayerInfo[extraid][pBanh] = strval(szResult);
					cache_get_field_content(row,  "KGFish", szResult, MainPipeline); PlayerInfo[extraid][pKGFish] = strval(szResult);
					cache_get_field_content(row,  "Buonngu", szResult, MainPipeline); PlayerInfo[extraid][pBuonngu] = strval(szResult);

					cache_get_field_content(row,  "NameRank", PlayerInfo[extraid][pNameRank], MainPipeline, 64);
					cache_get_field_content(row,  "KhuVuc", PlayerInfo[extraid][pKhuVuc], MainPipeline, 32);
					...
					cache_get_field_content(row,  "Sat", szResult, MainPipeline); PlayerInfo[extraid][pSat] = strval(szResult);	
					cache_get_field_content(row,  "Thep", szResult, MainPipeline); PlayerInfo[extraid][pThep] = strval(szResult);	
					cache_get_field_content(row,  "Dong", szResult, MainPipeline); PlayerInfo[extraid][pDong] = strval(szResult);	
					cache_get_field_content(row,  "Maydao", szResult, MainPipeline); PlayerInfo[extraid][pMaydao] = strval(szResult);	
					cache_get_field_content(row,  "pTogTaiXiu", szResult, MainPipeline); PlayerInfo[extraid][pTogTaiXiu] = strval(szResult);
					cache_get_field_content(row,  "pVang", szResult, MainPipeline); PlayerInfo[extraid][pVang] = strval(szResult);
					cache_get_field_content(row,  "active_status", szResult, MainPipeline); PlayerInfo[extraid][pactive_status] = strval(szResult);
					cache_get_field_content(row,  "pKimCuong", szResult, MainPipeline); PlayerInfo[extraid][pKimCuong] = strval(szResult);
					cache_get_field_content(row,  "Mask", szResult, MainPipeline); PlayerInfo[extraid][pMask] = strval(szResult);
					cache_get_field_content(row,  "pRuby", szResult, MainPipeline); PlayerInfo[extraid][pRuby] = strval(szResult);
					cache_get_field_content(row,  "pKhoangSan", szResult, MainPipeline); PlayerInfo[extraid][pKhoangSan] = strval(szResult);
					cache_get_field_content(row,  "pKhoangSans", szResult, MainPipeline); PlayerInfo[extraid][pKhoangSans] = strval(szResult);
                    cache_get_field_content(row,  "pNeon", szResult, MainPipeline); PlayerInfo[extraid][pNeon] = strval(szResult);
                    cache_get_field_content(row,  "pBinhxang", szResult, MainPipeline); PlayerInfo[extraid][pBinhxang] = strval(szResult);
                    cache_get_field_content(row,  "pChutiemxang", szResult, MainPipeline); PlayerInfo[extraid][pChutiemxang] = strval(szResult);
                    cache_get_field_content(row,  "pNhanvienxang", szResult, MainPipeline); PlayerInfo[extraid][pNhanvienxang] = strval(szResult);
                    cache_get_field_content(row,  "pMedkit", szResult, MainPipeline); PlayerInfo[extraid][pMedkit] = strval(szResult);
                    cache_get_field_content(row,  "pBombinh", szResult, MainPipeline); PlayerInfo[extraid][pBombinh] = strval(szResult);
                    cache_get_field_content(row,  "pQuathuong", szResult, MainPipeline); PlayerInfo[extraid][pQuathuong] = strval(szResult);
                    cache_get_field_content(row,  "pQuavang", szResult, MainPipeline); PlayerInfo[extraid][pQuavang] = strval(szResult);
                    cache_get_field_content(row,  "pQuavip", szResult, MainPipeline); PlayerInfo[extraid][pQuavip] = strval(szResult);
                    cache_get_field_content(row,  "pNVOnline", szResult, MainPipeline); PlayerInfo[extraid][pNVOnline] = strval(szResult);
                    cache_get_field_content(row,  "pNVTruck", szResult, MainPipeline); PlayerInfo[extraid][pNVTruck] = strval(szResult);
                    cache_get_field_content(row,  "pNVPizza", szResult, MainPipeline); PlayerInfo[extraid][pNVPizza] = strval(szResult);
                    cache_get_field_content(row,  "pNVMiner", szResult, MainPipeline); PlayerInfo[extraid][pNVMiner] = strval(szResult);
                    cache_get_field_content(row,  "pNVKhoBau", szResult, MainPipeline); PlayerInfo[extraid][pNVKhoBau] = strval(szResult);
                    cache_get_field_content(row,  "pNVDaNhan", szResult, MainPipeline); PlayerInfo[extraid][pNVDaNhan] = strval(szResult);
					...
					for(new i = 0; i < 12; i++)
					{
 					...
 					/*for(new am = 1; am < 9; am++)
					{
						format(szField, sizeof(szField), "Ammo%d", am);
						cache_get_field_content(row,  szField, szResult, MainPipeline);
						PlayerInfo[extraid][pAmmo][am] = strval(szResult);
					}*/

                    for(new am = 1; am < 9; am++)
					{
						format(szField, sizeof(szField), "wSaveSlot%d", am);
						cache_get_field_content(row,  szField, szResult, MainPipeline);
						PlayerInfo[extraid][pwSaveSlot][am] = strval(szResult);
					}

                    for(new am = 1; am < 9; am++)
					{
						format(szField, sizeof(szField), "aSaveSlot%d", am);
						cache_get_field_content(row,  szField, szResult, MainPipeline);
						PlayerInfo[extraid][paSaveSlot][am] = strval(szResult);
					}
					/*for(new i = 1; i < 9; i++)
                    {
                    ...
                    for(new i = 0; i < 6; i++)
					{
						format(szField, sizeof(szField), "BangDan%d", i);
						cache_get_field_content(row,  szField, szResult, MainPipeline);
						PlayerInfo[extraid][pBangDan][i] = strval(szResult);
					}*/
					for(new i = 0; i < 3; i++)
					{
						format(szField, sizeof(szField), "DeathPos_%d", i);
                    	cache_get_field_content(row, szField, szResult, MainPipeline); PlayerInfo[extraid][pDeathPos][i] = floatstr(szResult);
					}
					...
					//trangthai
					cache_get_field_content(row,  "SoCuu", szResult, MainPipeline); PlayerInfo[extraid][pSoCuu] = strval(szResult);
					cache_get_field_content(row,  "NuocLoc", szResult, MainPipeline); PlayerInfo[extraid][pNuocLoc] = strval(szResult);
					cache_get_field_content(row,  "BanhMi", szResult, MainPipeline); PlayerInfo[extraid][pBanhMi] = strval(szResult);
					cache_get_field_content(row,  "TogKhatNuoc", szResult, MainPipeline); PlayerInfo[extraid][pTogKhatNuoc] = strval(szResult);
					cache_get_field_content(row,  "KhatNuoc", szResult, MainPipeline); PlayerInfo[extraid][pKhatNuoc] = strval(szResult);
					cache_get_field_content(row,  "KhatNuocTimer", szResult, MainPipeline); PlayerInfo[extraid][pKhatNuocTimer] = strval(szResult);
					cache_get_field_content(row,  "ThieuNuocTimer", szResult, MainPipeline); PlayerInfo[extraid][pThieuNuocTimer] = strval(szResult);
					...
					cache_get_field_content(row,  "Bean", szResult, MainPipeline); PlayerInfo[extraid][pHasBean] = strval(szResult);
		...
		case SENDDATA_THREAD:
		{
			...
			//	ABroadCast(COLOR_YELLOW, "{AA3333}He thong{FFFF00}: !", 1);
		...
		case LOGIN_THREAD:
		{
			for(new i;i < rows;i++)
			{
				...
				if((isnull(szPass)) || (isnull(szResult)) || (strcmp(szPass, szResult) != 0)) {
					...
					HideNoticeGUIFrame(extraid);
					SendClientMessage(extraid, COLOR_RED, "SERVER: Sai mat khau!!");
					if(++gPlayerLogTries[extraid] == 2) {
						SendClientMessage(extraid, COLOR_RED, "SERVER: Sai mat khau 2 lan, ban tu dong bi kich ra khoi may chu.");
						// await task_ms(1500);
						// Kick(extraid);
						SetTimerEx("KickEx", 1500, 0, "i", extraid);
					}
					return 1;
				}
			...
			if(IsPlayerConnected(extraid))
			{
				...
				while(i < rows)
				{
					...
					if(PlayerVehicleInfo[extraid][i][pvModelId] != 0)
					{
						...
						cache_get_field_content(i,  "pvBug", szResult, MainPipeline);
						PlayerVehicleInfo[extraid][i][pvBug] = strval(szResult);
		...
		case IPBAN_THREAD:
		{
		    if(rows > 0)
			{
				SendClientMessage(extraid, COLOR_RED, "IP cua ban bi cam truy cap, de mo khoa vui long truy cap dien dan FORUM.SAMP-VN.COM");
				SetTimerEx("KickEx", 1000, 0, "i", extraid);
			}
			else
			{
		...
		case MAIN_REFERRAL_THREAD:
		{
		    ...
		    if(newrows == 0)
		    {
		        ...
		        ShowPlayerDialog(extraid, REGISTERREF, DIALOG_STYLE_INPUT, "{FF0000}Loi - Nguoi choi khong hop le", "Khong co nguoi choi dang ky tai may chu LSG voi ten nhu vay.\nVui long nhap ten day du nguoi choi da gioi thieu ban.\nVi du: Thanh_Vi", "Dong y", "Huy bo");
			}
			else {
		...
		case REWARD_REFERRAL_THREAD:
		{
			...
			if(newrows != 0)
			{
			    SendClientMessageEx(extraid, COLOR_YELLOW, "Nguoi choi da gioi thieu ban tham gia khong ton tai tren he thong LSG, vi vay ho se khong nhan duoc credits gioi thieu");
			}
		}
...
stock g_mysql_SaveVehicle(playerid, slotid)
{
	...
	format(query, sizeof(query), "%s `pvBug` = %d,", query, PlayerVehicleInfo[playerid][slotid][pvBug]);
...
stock g_mysql_SaveAccount(playerid)
{
    ...
    format(query, 2048, "UPDATE `accounts` SET ");
	SavePlayerString(query, GetPlayerSQLId(playerid), "NameRank", PlayerInfo[playerid][pNameRank]);
    SavePlayerString(query, GetPlayerSQLId(playerid), "KhuVuc", PlayerInfo[playerid][pKhuVuc]);
    ...
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin1", PlayerInfo[playerid][pSkin1]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin2", PlayerInfo[playerid][pSkin2]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin3", PlayerInfo[playerid][pSkin3]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin4", PlayerInfo[playerid][pSkin4]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin5", PlayerInfo[playerid][pSkin5]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Manhxe", PlayerInfo[playerid][pManhxe]);//pDirtyMoney
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin6", PlayerInfo[playerid][pSkin6]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin7", PlayerInfo[playerid][pSkin7]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin8", PlayerInfo[playerid][pSkin8]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin9", PlayerInfo[playerid][pSkin9]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin10", PlayerInfo[playerid][pSkin10]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin11", PlayerInfo[playerid][pSkin11]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin12", PlayerInfo[playerid][pSkin12]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin13", PlayerInfo[playerid][pSkin13]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin14", PlayerInfo[playerid][pSkin14]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin15", PlayerInfo[playerid][pSkin15]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin16", PlayerInfo[playerid][pSkin16]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin17", PlayerInfo[playerid][pSkin17]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin18", PlayerInfo[playerid][pSkin18]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin19", PlayerInfo[playerid][pSkin19]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Skin20", PlayerInfo[playerid][pSkin20]);
   ...
   // SavePlayerInteger(query, GetPlayerSQLId(playerid), "Phonebook", PlayerInfo[playerid][pPhoneBook]);
    ...
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Maydao", PlayerInfo[playerid][pMaydao]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Sat", PlayerInfo[playerid][pSat]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Thep", PlayerInfo[playerid][pThep]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Dong", PlayerInfo[playerid][pDong]);
...
/*    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Ammo1", PlayerInfo[playerid][pAmmo][1]);
	...
	/////
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "BangDan0", PlayerInfo[playerid][pBangDan][0]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "BangDan1", PlayerInfo[playerid][pBangDan][1]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "BangDan2", PlayerInfo[playerid][pBangDan][2]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "BangDan3", PlayerInfo[playerid][pBangDan][3]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "BangDan4", PlayerInfo[playerid][pBangDan][4]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "BangDan5", PlayerInfo[playerid][pBangDan][5]); */
	...
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "HackWeapons", PlayerInfo[playerid][pWeapons]);
...
/*    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Ammo1", PlayerInfo[playerid][pAmmo][1]);
    ...
    //trangthai
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "SoCuu", PlayerInfo[playerid][pSoCuu]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "NuocLoc", PlayerInfo[playerid][pNuocLoc]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "BanhMi", PlayerInfo[playerid][pBanhMi]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "TogLogo", PlayerInfo[playerid][pTogLogo]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "KhatNuoc", PlayerInfo[playerid][pKhatNuoc]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "KhatNuocTimer", PlayerInfo[playerid][pKhatNuocTimer]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "ThieuNuocTimer", PlayerInfo[playerid][pThieuNuocTimer]);
	...
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Bean", PlayerInfo[playerid][pHasBean]);
	...
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "ReceivedPrize", PlayerInfo[playerid][pReceivedPrize]);
	  ...
	  //cansa
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "HatGiong", PlayerInfo[playerid][pHatGiong]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "CanSa", PlayerInfo[playerid][pCansa]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Gang", PlayerInfo[playerid][pGang]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Giap", PlayerInfo[playerid][pGiap]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "CanSap", PlayerInfo[playerid][pCansap]);
    SavePlayerInteger(query, GetPlayerSQLId(playerid), "Banh", PlayerInfo[playerid][pBanh]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "KGFish", PlayerInfo[playerid][pKGFish]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "UidMask", PlayerInfo[playerid][pUidMask]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "ThuocSung", PlayerInfo[playerid][pThuocSung]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "DongCo", PlayerInfo[playerid][pDongCo]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "MuiXe", PlayerInfo[playerid][pMuiXe]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "BanhXe", PlayerInfo[playerid][pBanhXe]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Phieunuoibo", PlayerInfo[playerid][pPhieunuoibo]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Xabeng", PlayerInfo[playerid][pXabeng]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Buonngu", PlayerInfo[playerid][pBuonngu]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "CoLe", PlayerInfo[playerid][pCoLe]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Mph", PlayerInfo[playerid][pMph]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "BaiDauXe", PlayerInfo[playerid][pBaiDauXe]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Go", PlayerInfo[playerid][pGo]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Gpxl", PlayerInfo[playerid][pGpxl]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "FixJob", PlayerInfo[playerid][pFixJob]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "MoneyPhone", PlayerInfo[playerid][pMoneyPhone]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Gpvk", PlayerInfo[playerid][pGpvk]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pTogTaiXiu", PlayerInfo[playerid][pTogTaiXiu]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pVang", PlayerInfo[playerid][pVang]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "active_status", PlayerInfo[playerid][pactive_status]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pKimCuong", PlayerInfo[playerid][pKimCuong]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Mask", PlayerInfo[playerid][pMask]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pRuby", PlayerInfo[playerid][pRuby]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pKhoangSan", PlayerInfo[playerid][pKhoangSan]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pKhoangSans", PlayerInfo[playerid][pKhoangSans]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pNeon", PlayerInfo[playerid][pNeon]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "DauSach", PlayerInfo[playerid][pDauSach]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "Dau", PlayerInfo[playerid][pDau]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pBinhxang", PlayerInfo[playerid][pBinhxang]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pChutiemxang", PlayerInfo[playerid][pChutiemxang]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pNhanvienxang", PlayerInfo[playerid][pNhanvienxang]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pMedkit", PlayerInfo[playerid][pMedkit]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pBombinh", PlayerInfo[playerid][pBombinh]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pQuathuong", PlayerInfo[playerid][pQuathuong]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pQuavang", PlayerInfo[playerid][pQuavang]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pQuavip", PlayerInfo[playerid][pQuavip]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pNVOnline", PlayerInfo[playerid][pNVOnline]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pNVTruck", PlayerInfo[playerid][pNVTruck]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pNVPizza", PlayerInfo[playerid][pNVPizza]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pNVMiner", PlayerInfo[playerid][pNVMiner]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pNVKhoBau", PlayerInfo[playerid][pNVKhoBau]);
	SavePlayerInteger(query, GetPlayerSQLId(playerid), "pNVDaNhan", PlayerInfo[playerid][pNVDaNhan]);

	for(new i = 0; i < 3; i++)
	{
		new ss[128];
		format(ss, sizeof(ss), "DeathPos_%d", i);
		SavePlayerFloat(query, GetPlayerSQLId(playerid), ss, PlayerInfo[playerid][pDeathPos][i]);
	}
...
stock SavePlant(plant)
{
	...
	Plants[plant][pVirtual], Plants[plant][pInterior], Plants[plant][pGrowth], Plants[plant][pExpires], Plants[plant][_pDrugsSkill], plant+1);
	mysql_function_query(MainPipeline, query, false, "OnQueryFinish", "i", SENDDATA_THREAD);
	return 1;
}
	...
	if(IsPlayerConnected(index))
	{
		...
		switch(extraid)
		{
			...
			case 3: {
				...
				{
					PlayerInfo[index][pPnumber] = GetPVarInt(index, "WantedPh");
					format(string, sizeof(string), "   %s So dien thoai da duoc thiet lap thanh %d.", GetPlayerNameEx(index), GetPVarInt(index, "WantedPh"));
...
public OnLoadHouses()
{
	new i, rows, fields, szField[24], tmp[200];
	cache_get_data(rows, fields, MainPipeline);
...
public LoadDynamicGroupVehicles()
{
	...
	printf("Load xe faction/gang thanh cong");
    return 1;
}
		...
		case 1:
		{
			if(rows > 0)
			{
				...
				for(new i; i < rows; i++)
				{
					...
					format(hhour, sizeof(hhour), "%s", str_replacexx(":00:00", "", hhour));
					chour = strval(hhour);
	...
	*/
	...
	switch(iType) {
		...
		case GROUP_QUERY_LOAD: while(iIndex < iRows) {
			...
			cache_get_field_content(iIndex, "CauThangls", szResult, MainPipeline);
			arrGroupData[iIndex][g_iCauThangls] = strval(szResult);

			cache_get_field_content(iIndex, "BangGonls", szResult, MainPipeline);
			arrGroupData[iIndex][g_iBangGonls] = strval(szResult);
...
public PlantsLoadQuery() {
	...
	while((iIndex < iRows)) {
		...
		cache_get_field_content(iIndex, "DrugsSkill", szResult, MainPipeline); Plants[iIndex][_pDrugsSkill] = strval(szResult);
...
public BusinessesLoadQueryFinish()
{
	...
	while(i < rows)
	{
		...
		{
			for (new j, column[16], label[500]; j < MAX_BUSINESS_DEALERSHIP_VEHICLES; j++)
			{
                ...
                if(400 < Businesses[i][bModel][j] < 612) {
     				...
     				format(label, sizeof(label), "{ff3300}SHOP XE{FFFFFF}\n{00b33a}%s{FFFFFF} Hien dang ban\nGia ban hien tai: {00b33a}$%s{FFFFFF}.",GetVehicleName(Businesses[i][bVehID][j]), number_format(Businesses[i][bPrice][j]));
