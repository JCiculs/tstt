...
public OnFilterScriptInit()
{
	...
	Textdraw0 = TextDrawCreate(567.000000, 180.000000, "1   2");
	...
	Textdraw1 = TextDrawCreate(567.000000, 200.000000, "3   4");
	...
	Textdraw2 = TextDrawCreate(567.000000, 218.000000, "5");
	...
	Textdraw3 = TextDrawCreate(571.000000, 165.000000, "GEAR");
	...
	Textdraw5 = TextDrawCreate(571.000000, 186.000000, "°");
	...
	Textdraw6 = TextDrawCreate(589.500000, 186.000000, "°");
	...
	Textdraw7 = TextDrawCreate(571.000000, 205.000000, "°");
	...
	Textdraw8 = TextDrawCreate(589.500000, 205.000000, "°");
	...
	Textdraw9 = TextDrawCreate(571.000000, 223.000000, "°");
...
public OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
	...
	if (newkeys & KEY_SUBMISSION)
	{
		if (IsPlayerInAnyVehicle(playerid) && !IsVehiclePlane(GetPlayerVehicleID(playerid)))
		{
			...
			{
				SendClientMessage(playerid, COLOR_RED, "Ban khong the tang toc ngay bay gio.");
				return 1;
			}
	...
	if (newkeys & KEY_CROUCH)
	{
		...
		if (IsPlayerInAnyVehicle(playerid) && !IsVehiclePlane(GetPlayerVehicleID(playerid)))
		{
			...
			{
				SendClientMessage(playerid, COLOR_INDIGO, "Ban khong the giam toc ngay bay gio.");
				return 1;
			}
		    else if (PlayerGear[playerid] == 2)
			{
